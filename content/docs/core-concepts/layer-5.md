...
3. Spawn agent Claude Code headless untuk fase itu — agent membaca
   [Layer 1](/docs/core-concepts/layer-1) dan [Layer 2](/docs/core-concepts/layer-2),
   lalu menulis hasilnya ke [Layer 3](/docs/core-concepts/layer-3)
4. Menunggu hasil [Layer 4: Quality Gates](/docs/core-concepts/layer-4) sebelum memutuskan
...
| Layer | Peran |
|---|---|
| [1. Project Knowledge Base](/docs/core-concepts/layer-1) | Konteks proyek yang dibaca semua agent |
| [2. Agent Definitions](/docs/core-concepts/layer-2) | Peran, batasan akses, kebijakan retry tiap agent |
| [3. Artifact Handoff](/docs/core-concepts/layer-3) | Hasil tiap fase, disimpan sebagai Markdown di repo |
| [4. Quality Gates](/docs/core-concepts/layer-4) | Gate otomatis + gate manusia sebelum lanjut fase |

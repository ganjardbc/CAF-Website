...
| `implementer.md` | Menulis kode sesuai plan yang disetujui | Read-write |
| `verifier.md` | Scanner — lint, test, review otomatis | Read-only |
...
ditulis ke **Layer 3: Artifact Handoff** di setiap akhir fase.

...
(lihat [Layer 2: Agent Definitions](/docs/core-concepts/layer-2)). Hapus atau pindahkan
...
3. Nama status ticket cocok dengan mapping yang dikonfigurasi — lihat
   [Linear](/docs/integrations/linear) atau [Jira](/docs/integrations/jira)
...
dieskalasi (lihat [Layer 4: Quality Gates](/docs/core-concepts/layer-4)). Cek
...
[GitHub / GitLab](/docs/integrations/github-gitlab) untuk scope yang tepat.
